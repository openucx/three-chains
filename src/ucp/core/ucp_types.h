 ...
 * Currently the longest suffix is _payload_bound
 */
...
/* Max length of the triples that identify the targets of bitcode ifuncs */
#define UCP_IFUNC_TRIPLE_MAX    32

/* Max number of bitcode targets(triples) to support */
#define UCP_IFUNC_BC_TARGETS_MAX    4
